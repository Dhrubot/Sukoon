...
const canonicalPrayerGradients = {
  ...
  Isha: ['#010108', '#080C3A', '#101C48'] as const,
...
export const darkTheme = {
  ...
  // Meanings — prayer-meanings library (Phase 3 of "What You're Saying")
  meanings: {
    cardBg: palette.navy700,
    cardBorder: palette.navy500,
    arabicText: palette.white,
    arabicAccent: palette.gold400,
    transliterationText: palette.slate300,
    translationText: palette.slate200,
    reflectionText: palette.slate300,
    reflectionAccent: palette.gold400,
    sectionLabel: palette.gold400,
    sourceText: palette.slate500,
    chipBg: palette.navy600,
    chipText: palette.slate300,
    chipActiveBg: palette.green500,
    chipActiveText: palette.white,
    searchBg: palette.navy800,
    searchText: palette.white,
    searchPlaceholder: palette.slate400,
    searchBorder: palette.navy500,
    audioBg: palette.green500,
    audioIcon: palette.white,
    audioProgressTrack: palette.navy600,
    audioProgressFill: palette.green400,
    wordCardBg: palette.navy600,
    wordCardActiveBg: palette.green700,
    wordCardBorder: palette.navy500,
    wordRootText: palette.gold400,
    rootDivider: palette.navy500,
  },
...
export const lightTheme = {
  ...
  // Meanings — prayer-meanings library
  meanings: {
    cardBg: lightPalette.card,
    cardBorder: lightPalette.border,
    arabicText: lightPalette.text,
    arabicAccent: lightPalette.gold,
    transliterationText: lightPalette.textMuted,
    translationText: lightPalette.text,
    reflectionText: lightPalette.textMuted,
    reflectionAccent: lightPalette.gold,
    sectionLabel: lightPalette.gold,
    sourceText: lightPalette.textSub,
    chipBg: lightPalette.cream2,
    chipText: lightPalette.textMuted,
    chipActiveBg: lightPalette.teal,
    chipActiveText: lightPalette.card,
    searchBg: lightPalette.card,
    searchText: lightPalette.text,
    searchPlaceholder: lightPalette.textSub,
    searchBorder: lightPalette.border,
    audioBg: lightPalette.teal,
    audioIcon: lightPalette.card,
    audioProgressTrack: lightPalette.border,
    audioProgressFill: lightPalette.tealLight,
    wordCardBg: lightPalette.card2,
    wordCardActiveBg: lightPalette.tealDim,
    wordCardBorder: lightPalette.border,
    wordRootText: lightPalette.gold,
    rootDivider: lightPalette.border,
  },
...
const midnightPrayerGradients = {
  Fajr: ['#020310', '#0E183C', '#243660'] as const,
...
export const midnightTheme = {
  ...
  meanings: {
    cardBg: midnightPalette.card,
    cardBorder: midnightPalette.borderDim,
    arabicText: midnightPalette.text,
    arabicAccent: midnightPalette.gold,
    transliterationText: midnightPalette.textMuted,
    translationText: midnightPalette.text,
    reflectionText: midnightPalette.textMuted,
    reflectionAccent: midnightPalette.goldLight,
    sectionLabel: midnightPalette.gold,
    sourceText: midnightPalette.textSub,
    chipBg: midnightPalette.card2,
    chipText: midnightPalette.textMuted,
    chipActiveBg: midnightPalette.gold,
    chipActiveText: midnightPalette.night,
    searchBg: midnightPalette.card2,
    searchText: midnightPalette.text,
    searchPlaceholder: midnightPalette.textSub,
    searchBorder: midnightPalette.borderDim,
    audioBg: midnightPalette.gold,
    audioIcon: midnightPalette.night,
    audioProgressTrack: midnightPalette.borderDim,
    audioProgressFill: midnightPalette.goldLight,
    wordCardBg: midnightPalette.card2,
    wordCardActiveBg: midnightPalette.goldDim,
    wordCardBorder: midnightPalette.borderDim,
    wordRootText: midnightPalette.goldLight,
    rootDivider: midnightPalette.borderDim,
  },
